...
/**
 * print_class - Prints the class of ELF number.
...
/**
 * print_data - prints the data of an ELF numbers.
 * @e_ident: A pointer to an array containing the ELF class.
 */
...
/**
 * print_version - prints the version of ELF numbers.
 * @e_ident: A pointer to an array containing the ELF number.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
/**
 * main - Desplays the information contained.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	if (o == -1);
	{
		dprintf(STDERR_FILENO, "Error: Can't read file %d\n", argv[1]);
		exit(98);
	}
